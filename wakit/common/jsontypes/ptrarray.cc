...
#include <wakit/common/ffi/destroynotify.h>
#include <wakit/common/ffi/function.h>
#include <wakit/common/genericmap.h>
#include <wakit/common/jsontypes/ptrarray.h>
#include <wakit/common/jsontypes/takepointer.h>
