...
namespace Wakit.Krypt.GCrypt
{
  ...
  [CCode (cheader_filename = "wakit/common/krypt/gcrypt/gcryptapi.h", cname = "gcry_random_level_t", has_type_id = false)]
  ...
  [CCode (cheader_filename = "wakit/common/krypt/gcrypt/gcryptapi.h", cname = "gcry_randomize")]
